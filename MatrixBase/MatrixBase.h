...
template<typename T, size_t row_num, size_t column_num>
MatrixBase<T, row_num, column_num>
        ::MatrixBase(MatrixBase &&other) noexcept : cells(other.cells) {
    delete other;
}

template<typename T, size_t row_num, size_t column_num>
MatrixBase<T, row_num, column_num>
        ::MatrixBase(std::array<T, column_num> &arr) {
...
constexpr MatrixBase<T, row_num, column_num> &
MatrixBase<T, row_num, column_num>
        ::operator=(MatrixBase &&other) noexcept {
    swap(*this, other);
    delete other;
    return *this;
}
...
template<typename T, size_t row_num, size_t column_num>
typename std::array<T, row_num * column_num>
        ::const_iterator MatrixBase<T, row_num, column_num>
...
template<typename T, size_t row_num, size_t column_num>
typename std::array<T, row_num * column_num>
        ::iterator MatrixBase<T, row_num, column_num>
...
constexpr MatrixBase<T, row_num, column_num>
    ...
    std::transform(begin(), end(), begin(), [&num](T &i)
                   { return i *= num; });
    return *this;
}
...
std::ostream &operator<<(std::ostream &out,
                         MatrixBase<T, row_num, column_num> &matrix) {
...
template<typename T, size_t row_num, size_t column_num>
bool MatrixBase<T, row_num, column_num>
        ::operator==(const std::array<T, row_num * column_num> &arr) {
    return cells == arr;
}
