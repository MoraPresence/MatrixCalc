...
check_log "clang-tidy ./Tests/*.cpp -warnings-as-errors=* -extra-arg=-std=c++17 -- -ITP2022_CPP_MatrixCalc/TP2022_CPP_MatrixCalc/MatrixBase/" "Error (?:reading|while processing)"
